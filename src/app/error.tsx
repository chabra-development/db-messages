        ...
        <div className="w-full max-w-3xl space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground max-w-md mx-auto">
                Ocorreu um erro inesperado. Todas as informacoes relevantes
                estao disponiveis abaixo para diagnostico.
              </p>
            </div>
          </div>
          ...
          <Card className="border-destructive/20">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Informacoes completas para diagnostico e suporte tecnico
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Detalhes sobre a URL e navegacao
              </CardDescription>
            </CardHeader>
              ...
              <CardContent>
                <div className="grid grid-cols-1 divide-y divide-border">
                  <InfoRow
                    icon={Globe}
                    label="URL Completa"
                    value={routeInfo.fullUrl}
                    mono
                  />
                  <InfoRow
                    icon={MapPin}
                    label="Pathname"
                    value={routeInfo.pathname}
                    mono
                  />
                  <InfoRow
                    icon={Hash}
                    label="Query String"
                    value={routeInfo.search || "Nenhuma"}
                    mono
                  />
                  <InfoRow
                    icon={Hash}
                    label="Hash"
                    value={routeInfo.hash || "Nenhum"}
                    mono
                  />
                  <InfoRow
                    icon={Server}
                  ...
                  <InfoRow
                    icon={Link2}
                    label="Protocolo"
                    value={routeInfo.protocol}
                  />
                  <InfoRow
                    icon={Link2}
                    label="Referrer"
                    value={routeInfo.referrer}
                  />
                  <InfoRow
                    icon={Layers}
                    label="Historico de Navegacao"
                    value={`${routeInfo.historyLength} paginas`}
                  />
                </div>
              </CardContent>
            )}
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Informacoes do ambiente do usuario
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-border">
                    ...
                    <div className="space-y-0 pl-0 sm:pl-4 pt-2 sm:pt-0">
                      ...
                      <InfoRow
                        icon={Monitor}
                        label="Color Depth"
                        value={`${browserInfo.colorDepth} bits`}
                      />
                      <InfoRow
                        icon={Cpu}
                        label="CPU Cores"
                        value={browserInfo.hardwareConcurrency}
                      />
                      ...
                      <InfoRow
                        icon={Monitor}
                        label="Touch Points"
                        value={browserInfo.maxTouchPoints}
                      />
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Baixe todas as informacoes do erro para compartilhar com o
                      suporte
                    </p>
                  </div>
                </div>
          ...
          <p className="text-center text-xs text-muted-foreground pt-2">
            Se o problema persistir, exporte o relatorio e envie para o suporte
            tecnico.
          </p>
        </div>
      </main>
