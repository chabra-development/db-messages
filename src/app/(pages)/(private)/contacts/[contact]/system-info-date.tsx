...
export const SystemInfoDate = ({ date, index, array }: SystemInfoDateProps) => {
  const currentDate = date;

  const previousDate = index > 0 ? new Date(array[index - 1].sentAt) : null;
  ...
  if (showDateDivider) {
    return (
      <Badge variant="secondary" className="text-xs mx-auto py-2 px-4 mb-3">
