...
export type SystemLogRow = Pick<
    SystemLog,
    "id" | "level" | "category" | "action" | "message" | "entityId" | "userId" | "metadata" | "createdAt"
>
...
> = {
    ...
    WARN: { variant: "outline", label: "WARN", className: "border-yellow-500 text-yellow-600 dark:text-yellow-400" },
