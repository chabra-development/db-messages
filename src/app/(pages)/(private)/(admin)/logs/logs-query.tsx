    ...
    const { data, isLoading, isFetching } = useQuery({
        ...
        queryFn: () =>
            findManySystemLogs({
                ...
                category: category as "all" | "IMPORT" | "JOB" | "USER_MANAGEMENT" | "AUTH" | "SYSTEM",
            }),
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2">
                <Select value={level} onValueChange={(v) => { setLevel(v); setSkip(0) }}>
                ...
                <Select value={category} onValueChange={(v) => { setCategory(v); setSkip(0) }}>
