...
export const ChangeColorDialog = ({ id, color }: ChangeColorDialogProps) => {
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Alterar cor da tag</AlertDialogTitle>
          <AlertDialogDescription>Altera a cor da tag</AlertDialogDescription>
        </AlertDialogHeader>
        <FormChangeColorTagDialog id={id} onOpenChange={setOpen} />
        <AlertDialogFooter>
          <AlertDialogCancel variant={"destructive"}>
            Cancelar
          </AlertDialogCancel>
          <AlertDialogAction type="submit" form="form-change-tag-color">
            Continue
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
