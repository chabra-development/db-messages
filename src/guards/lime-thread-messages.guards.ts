...
export function isLimeStaticFileContent(
  value: unknown,
): value is LimeMediaContent {
...
export function isLimeEmojiReaction(
  value: unknown,
): value is LimeEmojiReaction {
...
export function isLimeSelectContent(
  value: unknown,
): value is LimeSelectContent {
...
export function isLimeInteractiveButton(
  value: unknown,
): value is z.infer<typeof LimeInteractiveButtonSchema> {
...
export function isLimeInteractiveList(
  value: unknown,
): value is z.infer<typeof LimeInteractiveListSchema> {
...
export function isLimeInteractiveMessage(
  value: unknown,
): value is LimeInteractiveMessage {
...
export function isLimeReplyToInteractive(
  value: unknown,
): value is LimeReplyToInteractive {
...
export function isLimeReplyToSelect(
  content: unknown,
): content is LimeReplyToSelect {
...
export function isLimeReplyToMedia(
  content: unknown,
): content is LimeReplyToMedia {
...
export function isLimeReplyToContact(
  value: unknown,
): value is LimeReplyToContact {
...
export function isLimeReplyToUnknown(
  content: unknown,
): content is LimeReplyToUnknown {
