...
import { Check, Gauge, PauseIcon, PlayIcon, Settings } from "lucide-react"
...
interface AudioPlayerProviderProps<TData = unknown> {
    children: ReactNode
    url?: string
    id?: string | number
    data?: TData
...
export function AudioPlayerProvider<TData = unknown>({
    ...
    useEffect(() => {
        ...
        const item: AudioPlayerItem<TData> = {
            id,
            src: url,
            data,
        }
...
>) => {
    ...
    return (
        ...
        >
            <SliderPrimitive.Track className="bg-card/80 relative h-1.5 w-full grow overflow-hidden rounded-full">
